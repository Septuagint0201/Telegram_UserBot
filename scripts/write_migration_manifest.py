...
EXPECTED_REVISION = "0022_m7_job_scope_and_deadline"
...
def build_manifest(root: Path, database_dsn: str, redis_url: str) -> dict[str, object]:
    ...
    return {
        ...
        "migration_sha256": _hash(
            root / "alembic" / "versions" / "0022_m7_job_scope_and_deadline.py"
        ),
        "migration_chain_sha256": {
            ...
            "0013_m5_m7_consistency": _hash(
                root / "alembic" / "versions" / "0013_m5_m7_consistency.py"
            ),
            "0014_m7_budget_integrity": _hash(
                root / "alembic" / "versions" / "0014_m7_budget_integrity.py"
            ),
            ...
            "0017_m5_m7_recovery_binding": _hash(
                root / "alembic" / "versions" / "0017_m5_m7_recovery_binding.py"
            ),
            "0018_m5_retry_budget_proof": _hash(
                root / "alembic" / "versions" / "0018_m5_retry_budget_proof.py"
            ),
            ...
            "0021_m7_evidence_activity": _hash(
                root / "alembic" / "versions" / "0021_m7_evidence_activity.py"
            ),
            "0022_m7_job_scope_and_deadline": _hash(
                root / "alembic" / "versions" / "0022_m7_job_scope_and_deadline.py"
            ),
        },
