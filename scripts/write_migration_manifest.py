"""Record content-free M1 PostgreSQL/Redis compatibility and schema evidence."""
...
EXPECTED_REVISION = "0001_m1_durable_state"
...
def build_manifest(root: Path, database_dsn: str, redis_url: str) -> dict[str, object]:
    ...
    return {
        ...
        "migration_sha256": _hash(root / "alembic" / "versions" / "0001_m1_durable_state.py"),
        "roles_sha256": _hash(root / "deploy" / "postgres" / "m1_roles.sql"),
        ...
        "migration_paths": {
            ...
            "previous_supported_to_head": "NOT_APPLICABLE_BASELINE",
