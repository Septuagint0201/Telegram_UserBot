        ...
        *,
        ...
        await self._session.execute(
            insert(model_capability_snapshots).values(
                ...
                max_image_bytes_per_request=capabilities.max_image_bytes_per_request,
                auto_image_tokens=capabilities.auto_image_tokens,
                messages_auto_detail_equivalent=capabilities.messages_auto_detail_equivalent,
...
def _capabilities_from_row(
    ...
    return ModelCapabilities(
        ...
        max_images_per_request=cast(int, raw["max_images_per_request"]),
        max_image_bytes_per_request=cast(int, raw["max_image_bytes_per_request"]),
        auto_image_tokens=cast(int, raw["auto_image_tokens"]),
        messages_auto_detail_equivalent=cast(bool, raw["messages_auto_detail_equivalent"]),
    )
